...
UI_info = pygame_gui.elements.UITextBox('esc: pause game\n'
                                        'enter: close game'
                                        'wasd: walking\n'
                                        'mouse: aiming\n'
                                        'Spacebar: shooting\n'
                                        'l: start game', pygame.Rect(display_info.current_w - 300, 0, 300, 150), UI_Manager)
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if state == START:
            ...
            if default_gun.is_reloading:
                UI_is_reloading = 'R...'
            else: UI_is_reloading = default_gun.ammo
            UI_items.set_text(f'Time: {convert_time()}\nKills: {player_kill_count}\npoints: {player_points}\ncoins: {player_coins}\n\nhealth: {player.health}\nmagazine: {UI_is_reloading}')
